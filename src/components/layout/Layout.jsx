...
const Layout = (props) => {
    ...
    useEffect(() => {
        ...
        client.on('connect', () => {
            ...
            client.subscribe(`nonameex2/feeds/${FEED_BUZZER}/json`);
            client.subscribe(`nonameex2/feeds/${FEED_LED}/json`);
        ...
        client2.on('connect', () => {
            ...
            client2.subscribe(`nonameex1/feeds/${FEED_GAS}/json`);
            ...
            if (JSON.parse(message).key === FEED_GAS) {
                if (value > 0) {
                    ...
                    if (getSettingsLocalStorage('fanmode') === 'auto') {
                        ...
                        sendData(10, FEED_DRV_NAME, FEED_DRV, fanSpeed, ACTIVE_KEY2, USERNAME2);
                    }
                    sendSMS();
                    ...
                    //SEND DATA TO FEED_BUZZER
                    if (getSettingsLocalStorage('fanmode') === 'auto') {
                        sendData(10, FEED_DRV_NAME, FEED_DRV, 0, ACTIVE_KEY2, USERNAME2);
                    }
                    //SEND DATA TO FEED_DRV
                }
                dispatch({
